...
// Ported from the source app's Finance/ViewPDF.js + Legal/ViewPDF.js — the
// two were near-duplicates in the source; this is ONE shared viewer for
// both, parameterized by the fileName/extension query params ProfileTab
// (and, once ported, the Finance/Legal question views) link to.
